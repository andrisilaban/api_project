...
PassengersModel PassengersModelFromJson(String str) => PassengersModel.fromJson(json.decode(str));

String PassengersModelToJson(PassengersModel data) => json.encode(data.toJson());
